...
class JWTService:
    ...
    """
    def __init__(self, private_key: str, public_key: Optional[str], algorithm: str, token_lifetime: timedelta,
                 refresh_secret: Union[str, bytes], refresh_token_lifetime: timedelta):
    ...
    def get_user_from_jwt(self, token: str) -> Optional[UserTO]:
        ...
        try:
            jwt_payload = jwt.decode(token, self._public_key, algorithms=self._alg, options=options)
