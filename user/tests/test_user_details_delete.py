...
class TestUserDetailsDelete(TestCase):
    def setUp(self):
        cmd = flush.Command()
    ...
    def test_details_on_admin_self_success(self):
        ...
        self.assertEquals(modified_user.is_active, False)
    ...
    def test_details_on_non_admin_self_failed(self):
        ...
        modified_user = User.objects.get(pk=2)
        self.assertEquals(modified_user.is_active, True)
