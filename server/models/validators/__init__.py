from .user_schemas import CreateUserSchema, LoginUserSchema, SetPasswordUserSchema, \
    SetUserDataSchema, SetUserGroupsSchema
...
set_user_groups_validator = SetUserGroupsSchema()
