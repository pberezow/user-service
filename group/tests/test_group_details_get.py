...
class TestGroupDetailsGet(TestCase):
    def setUp(self):
        cmd = flush.Command()
    ...
    def test_get_group_on_admin(self):
    ...
    def test_get_group_on_admin_another_licence_group(self):
        client.credentials(HTTP_AUTHORIZATION='Bearer ' + self.admin_header)
        response = client.get(
    ...
    def test_get_group_on_non_admin(self):
